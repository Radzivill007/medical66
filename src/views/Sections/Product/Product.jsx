    ...
    return (
        <PageSection className={clsx("product-section", className)} id={anchor}>
            ...
            <Row className="justify-content-center">
                {products.map(
                    ({ content, extraInfo, header, imageFileName, imageFileNameDetail, subheader, subheaderOutside, more, close }) => (
                        <ProductItem
                            key={header}
            ...
            <div className="mt-n3">
                ...
                <ul>
                    <li>Ортез и костыли на месяц за 2800 руб. с бесплатной доставкой</li>
